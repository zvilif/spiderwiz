 ...
 * {@link javax.xml.bind.annotation.XmlType XmlType} annotation are implicitly serializable and therefore do not require the
 * explicit {@code WizSerializable} annotation.
 */
@Inherited
