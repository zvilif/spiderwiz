...
class CoreConsts {
    ...
    static final String NEED_INCLUDE_XADMIN =
        "Include spiderwiz-admin dependency in your project in order to use www.spideradmin.com";
    ...
    public class DataChannel {
        ...
        public static final String FLUSHLOGS = "flushlogs";
        ...
        public static final String PINGRATE = "ping-rate";
        public static final int DEFAULT_PINGRATE = 60;
        ...
        public static final String DISCONNECT_CHANNEL = "A connection to %1$s has been dropped. Reason: %2$s";
        public static final String CONNECTION_OK = "A connection to %1$s has been established";
        public static final String FILE_LOGIN_EXCEPTION = "Exception while trying to log into a file channel";
    }
