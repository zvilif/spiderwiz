...
public abstract class ZThread implements Runnable {
     ...
     * {@link #activate()}.
     * @return the time of the day as the number of milliseconds after midnight that the thread action runs at.
     * @see #getLoopInterval()
     */
     ...
     * other cases, the method activates the action immediately regardless of the set loop rate.
     */
